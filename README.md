# javab-agent
This repository contains the code of a JVMTI agent which automatically analyses the JVM bytecode during runtime and exploit the implicit loop parallelism in the code and parallelize it on the fly. The research paper accompanying this repository was published in the [Proceedings of 2018 9th International Conference on E-Education, E-Business, E-Management and E-Learning (IC4E 2018)](https://dl.acm.org/doi/abs/10.1145/3183586.3183607), held in San Diego, USA.
